...
- `docs/workstation.md` — the capability layer: `profiles/desktop/` (DE, audio,
  idle/suspend) and `profiles/dev/` (Podman, Connect IQ, network tools), plus
  the system modules backing them.
...
- Design a genuinely new *kind* of module or profile for the new host to use —
