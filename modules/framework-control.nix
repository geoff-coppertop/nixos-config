...
in {
  options.services.framework-control = {
    ...
    package = lib.mkOption {
      ...
      default = pkgs.callPackage ../pkgs/framework-control.nix {};
      defaultText = lib.literalExpression "pkgs.callPackage ../pkgs/framework-control.nix {}";
      description = "The framework-control package to use.";
    };
  };
