...
| `custom.autoRip.hardwareEncode` | Swaps in a QSV-enabled HandBrakeCLI (`pkgs/handbrake-qsv.nix`, a from-source build nixpkgs doesn't ship) and passes `/dev/dri` in. Off by default and not yet enabled anywhere — untested end-to-end |
