...
| Secret | Contents | Host recipients |
| --- | --- | --- |
| `traefik/cloudflare-api-token.age` | `CLOUDFLARE_DNS_API_TOKEN=<Cloudflare Zone:DNS:Edit token>` — lego's actual env var name for the cloudflare provider | `reliant` |
