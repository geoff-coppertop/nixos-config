# Home Assistant automation for defiant: presence-driven room lighting.
#
...
# extraComponent, both in hosts/defiant/configuration.nix). HA exposes the FP1e
...
# `presence` and update it after commissioning.
#
