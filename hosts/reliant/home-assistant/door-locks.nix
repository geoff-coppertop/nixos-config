# Home Assistant automation for reliant: lock the doors at night.
#
...
# is listed in the HA extraComponents — both in hosts/reliant/configuration.nix).
...
# Copied from hosts/defiant/home-assistant/door-locks.nix — re-verify these
# entity IDs against the running instance on this host once activated.
#
